...
1. Choose/open the next `core-data-rest-layer` todo; pending-change semantics (`009`), structured metadata (`010`), fail-fast supported surface (`011`), and cancellation/timeouts (`012`) are done.
