...
- `experiments/vision-pro-4d-raytracer/` — spike for a Metal 4D raytracer projected into a binocular Vision Pro experience; CPU camera/projection math, Metal volume probe, and contact-sheet/PLY volume exports are in place, next is a native visionOS point-cloud viewer; read `experiments/vision-pro-4d-raytracer/docs/HANDOFF.md`.
...
1. For `vision-pro-4d-raytracer`, work local todo `004`: build a native visionOS/RealityKit point-cloud viewer for the Metal-generated 3D projection volume.
